...
export interface SearchableSelectProps {
  ...
  /**
   * Extra classes for the trigger button, merged over its form-field chrome — for a control that
   * sits in a toolbar rather than a form, e.g. `h-9 bg-transparent ring-0`.
   */
